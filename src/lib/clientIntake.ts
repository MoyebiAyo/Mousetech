...
export const intakeSteps: IntakeStep[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "portfolioSamples", label: "Portfolio / work samples", type: "textarea", placeholder: "Images, videos, links, case studies, quantity..." },
      { name: "projectDescriptions", label: "Project descriptions", type: "textarea", placeholder: "Titles, roles, summaries, outcomes..." },
      { name: "testimonials", label: "Testimonials", type: "textarea", placeholder: "Written testimonials, video links, names, roles..." },
  ...
  },
  {
    ...
    fields: [
      { name: "hasLogo", label: "Do you have a logo?", type: "select", required: true, options: ["Yes", "No", "Needs refinement"] },
      ...
      { name: "existingStyleGuide", label: "Existing style guide?", type: "select", options: ["Yes", "No", "Not sure"] },
    ],
  },
  {
    id: "technical",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "filesToProvide", label: "Files to be provided", type: "textarea", placeholder: "Photos, logos, copy, CV, brand guide, videos..." },
      {
