...
export default function Services() {
  return (
    <section id="services" className="py-24" style={{ background: '#f7f9fc' }}>
      <div className="max-w-[1100px] mx-auto px-[5%]">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-8 mb-14">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs font-bold tracking-widest uppercase" style={{ color: '#1e5fa8' }}>What We Offer</span>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div className="service-card-icon group-hover:bg-[#1e5fa8] group-hover:text-white transition-all duration-300">
